...
<?php if( $assignments ) { ?>
	...
	<table cellpadding="0" cellspacing="0" style="width: 700px; margin: 0pt auto;" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
		...
		<tbody>
		    ...
		    <tr>
		        ...
		        <td>
		        	<?php echo $this->Html->link(__('Edit'), array( 'controller' => 'articles', 'action' => 'edit_assignment', $a['WriterAssignment']['id']), null); ?>
				</td>
		    </tr>
		    <?php } ?>
	    </tbody>
