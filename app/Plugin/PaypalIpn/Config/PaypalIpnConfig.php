...
class PaypalIpnConfig {
  ...
  var $settings = array(
    ...
    'notify_url' 	=> '/paypal_ipn/process', //'http://www.yoursite.com/paypal_ipn/process', //Notify_url... set this to the process path of your paypal_ipn::instant_payment_notification::process action
  ...
  var $testSettings = array(
    'business' 		=> 's1_1331026488_biz@gmail.com', //'sandbox_email@paypal.com',
    'server' 		=> 'https://www.sandbox.paypal.com',
    'notify_url'	=> '/paypal_ipn/process', //'http://www.yoursite.com/paypal_ipn/process',
    'currency_code' => 'USD',
    'lc' 			=> 'US',
