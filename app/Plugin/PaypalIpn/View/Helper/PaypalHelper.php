...
class PaypalHelper extends AppHelper {
  ...
  function __construct(View $View, $settings = array()){
  	...
  	/*
    if(App::import(array('type' => 'File', 'name' => 'PaypalIpn.PaypalIpnConfig', 'file' => 'paypal_ipn_config.php'))){
  ...
  function __submitButton($text){
    return "</div>" . $this->Form->end(array('label' => $text, 'class' => 'btn btn-success'));
  }
